...
# NOTE: We use the `hydra` client (version 1.11.10) to create OAuth2
#       clients in the docker-compose examples. Thankfully, the hydra
#       executable is small enough to not bother us.
